...
HorasExtrasDoMes = int (input())
ValorDaHoraTrabalhada = (SalarioBase/44) 
ValorTotalDasHorasExtras = (HorasExtrasDoMes * ValorDaHoraTrabalhada)
DezPorCentoDaHoraExtra = (ValorTotalDasHorasExtras/100) * 10
SalarioFinal = (SalarioBase + ValorTotalDasHorasExtras + DezPorCentoDaHoraExtra)
print ("{:.2f}" .format (SalarioFinal))